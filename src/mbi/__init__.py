...
if jax.config.jax_enable_compilation_cache:
    warnings.warn(
        ...
        " small compiled programs (one per unique clique/domain combination),"
        " which makes the cache counterproductive — especially when running"
        " sweeps of experiments that all write to the same cache location."
